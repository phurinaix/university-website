...
<html>
	<head>
		<title>History</title>
		<meta charset="utf-8">
		<?php echo '<link rel="stylesheet" type="text/css" href="classroom-thai.css">'; ?>
	...
	<body>
				...
				<div id = "header-inner">
					...
					<nav>
						...
						<ul>
							...
							<li><a href = "life-thai.php" class="current">ชีวิตนักศึกษา</a></li>
							<a href="classroom-eng.php"><img src="img/uk.jpg" alt="thai" width="40px" height="20px" class="flag"></a>
		...
		<div id="container">
			<div>
				<img src="img/classroom1.jpg" width="100%">
			</div>
			<div id="container-inside">
				<div id="text">
					<h3>ห้องเรียน</h3>
					<p>มหาวิทยาลัยธรรมศาสตร์ ศูนย์พัทยา มีห้องเรียนสำหรับวิศวกรรมซอฟต์แวร์ และวิศวกรรมยานยนตร์</p>
					<div>
						<img src="img/classroom2.jpg" width="700px" height="400px">
					</div>
				</div>
				<div id="menubar">
					<a href="dorm-thai.php">
					<div class="menubar-inner">
						<i class="fa fa-building" style="font-size:24px"></i> หอพัก
					</div>
					</a>
					<a href="library-thai.php">
					<div class="menubar-inner">
						<i class="fa fa-book" style="font-size:24px"></i> ห้องสมุด
					</div>
					</a>
					<a href="classroom-thai.php">
					<div class="menubar-inner current1">
						<i class="fa fa-tv" style="font-size:24px"></i> ห้องเรียน
					</div>
					</a>
				</div>
			</div>
