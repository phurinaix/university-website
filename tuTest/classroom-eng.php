...
<html>
	<head>
		<title>History</title>
		<meta charset="utf-8">
		<?php echo '<link rel="stylesheet" type="text/css" href="classroom-eng.css">'; ?>
				...
				<div id = "header-inner">
					...
					<nav>
						...
						<ul>
							...
							<a href="classroom-thai.php"><img src="img/thai.png" alt="thai" width="40px" height="20px" class="flag"></a>
			...
			<div id="container-inside">
				...
				<div id="menubar">
					...
					<div class="menubar-inner">
						<i class="fa fa-building" style="font-size:24px"></i>Dormitory
					</div>
					</a>
					<a href="library-eng.php">
					<div class="menubar-inner">
						<i class="fa fa-book" style="font-size:24px"></i> Library
					</div>
					</a>
					<a href="classroom-eng.php">
					<div class="menubar-inner current1">
						<i class="fa fa-tv" style="font-size:24px"></i> Classroom
					</div>
					</a>
				</div>
			</div>
