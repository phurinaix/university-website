...
<html>
	<head>
		<title>History</title>
		<meta charset="utf-8">
		<?php echo '<link rel="stylesheet" type="text/css" href="life-thai.css">'; ?>
	...
	<body>
				...
				<div id = "header-inner">
					...
					<nav>
						...
						<ul>
							...
							<a href="life-eng.php"><img src="img/uk.jpg" alt="thai" width="40px" height="20px" class="flag"></a>
		...
		<div id="content">
			<div class="life">
				<a href="dorm-thai.php"><div id="pic1"></div></a>
			</div>
			<div class="life">
				<a href="library-thai.php"><div id="pic2"></div></a>
			</div>
			<div class="life">
				<a href="classroom-thai.php"><div id="pic3"></div></a>
			</div>
		</div>
