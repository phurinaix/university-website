...
<html>
	<head>
		<title>History</title>
		<meta charset="utf-8">
		<?php echo '<link rel="stylesheet" type="text/css" href="library-thai.css">'; ?>
	...
	<body>
				...
				<div id = "header-inner">
					...
					<nav>
						...
						<ul>
							...
							<a href="library-eng.php"><img src="img/uk.jpg" alt="thai" width="40px" height="20px" class="flag"></a>
		...
		<div id="container">
			<div>
				<img src="img/library1.jpg" width="100%">
			</div>
			<div id="container-inside">
				<div id="text">
					<h3>ห้องสมุด</h3>
					<p>มหาวิทยาลัยธรรมศาสตร์ศูนย์พัทยามีหนังสือหลากหลายหมวดหมู่ให้อ่าน</p>
					<div>
