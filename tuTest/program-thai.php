...
<html>
	<head>
		<title>History</title>
		<meta charset="utf-8">
		<?php echo '<link rel="stylesheet" type="text/css" href="program-thai1.css">'; ?>
	...
	<body>
				...
				<div id = "header-inner">
					...
					<nav>
						...
						<ul>
							...
							<li class="dropdown"><a href = "program-thai.php" class="droptn current">หลักสูตร</a>
								<div class="dropdown-content">
							...
							<a href="program-eng.php"><img src="img/uk.jpg" alt="thai" width="40px" height="20px" class="flag"></a>
		...
		<div id="container">
			<div id="inside">
				<div class="display">
					<a href="soft-thai.php"><img src="img/software.png" width="400px" height="220px" class="image"></a>
					<a href="soft-thai.php"><h3>วิศวกรรมซอฟต์แวร์</h3></a>
				</div>
				<div class="display">
					<a href="auto-thai.php"><img src="img/automotive.jpg" width="400px" height="220px" class="image"></a>
					<a href="auto-thai.php"><h3>วิศวกรรมยานยนตร์</h3></a>
				</div>
			</div>
		</div>
